...
function Tasks() {
  ...
  const code = `<div className="m-auto mt-4 max-w-md rounded-xl shadow-lg shadow-slate-900">
  <p className="text-md p-4 font-bold text-white/70">
    My Tasks
    <span className="ml-2 text-sm text-gray-500">(05)</span>
  </p>
  <ul>
    <li className="flex items-center justify-between border-b border-slate-900 py-3 text-gray-600">
    ...
    <li className="flex items-center justify-between border-b border-slate-900 py-3 text-gray-400 dark:border-gray-800">
      <div className="flex items-center justify-start text-sm">
  ...
  return (
    <div>
      ...
      {see === 'demo' ? (
        <div className="m-auto mt-4 max-w-md rounded-xl shadow-lg shadow-slate-900">
          <p className="text-md p-4 font-bold text-white/70">
            My Tasks
            <span className="ml-2 text-sm text-gray-500">(05)</span>
          </p>
